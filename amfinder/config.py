...
HTTP_TIMEOUT = float(os.environ.get("AMF_HTTP_TIMEOUT", "15"))

# Batas per request biar function serverless gak kelamaan.
MAX_SCAN_ITEMS = int(os.environ.get("AMF_MAX_SCAN_ITEMS", "12"))
MAX_LIST_ITEMS = int(os.environ.get("AMF_MAX_LIST_ITEMS", "60"))
